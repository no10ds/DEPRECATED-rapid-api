...
IDENTITY_PROVIDER_TOKEN_URL = f"{IDENTITY_PROVIDER_BASE_URL}{BASE_API_PATH}/oauth2/token"
IDENTITY_PROVIDER_AUTHORIZATION_URL = f"{IDENTITY_PROVIDER_BASE_URL}{BASE_API_PATH}/oauth2/authorize"
IDENTITY_PROVIDER_LOGOUT_URL = f"{IDENTITY_PROVIDER_BASE_URL}{BASE_API_PATH}/logout"
...
COGNITO_LOGOUT_URI = f"https://{DOMAIN_NAME}{BASE_API_PATH}/login"
