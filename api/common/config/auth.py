...
CENTRAL_DOMAIN_NAME = os.getenv("CENTRAL_DOMAIN_NAME", DOMAIN_NAME)
COGNITO_RESOURCE_SERVER_ID = "https://" + CENTRAL_DOMAIN_NAME
COGNITO_USER_POOL_ID = os.environ["COGNITO_USER_POOL_ID"]
CENTRAL_RESOURCE_PREFIX = os.getenv("CENTRAL_RESOURCE_PREFIX", RESOURCE_PREFIX)
IDENTITY_PROVIDER_TOKEN_URL = (
    "https://"
    + CENTRAL_RESOURCE_PREFIX
    + "-auth.auth."
    + AWS_REGION
