...
from api.common.config.auth import IDENTITY_PROVIDER_TOKEN_URL, COGNITO_USER_LOGIN_APP_CREDENTIALS_SECRETS_NAME, \
    COGNITO_REDIRECT_URI, COOKIE_MAX_AGE_IN_SECONDS
...
async def auth_success_callback(code: str):
    cognito_user_login_client_id, cognito_user_login_client_secret = await _get_client_info()
