...
from api.common.config.auth import IDENTITY_PROVIDER_AUTHORIZATION_URL, COGNITO_REDIRECT_URI
...
class TestLoginPage(BaseClientTest):
    ...
    def test_calls_templating_engine_with_expected_arguments(self, mock_templates_response, mock_get_secret):
...
class TestUploadPage(BaseClientTest):
    ...
    @patch.object(Jinja2Templates, "TemplateResponse")
    def test_calls_templating_engine_with_expected_arguments(self, mock_templates_response, mock_extract_users):
