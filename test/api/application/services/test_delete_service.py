...
from api.common.custom_exceptions import CrawlerIsNotReadyError, CrawlerStartFailsError, UserError
...
class TestDeleteService:
    ...
    def test_delete_schema(self):
        ...
        self.s3_adapter.delete_schema.assert_called_once_with('domain', 'dataset', 'PUBLIC')

    def test_delete_file_when_crawler_is_ready(self):
        self.delete_service.delete_dataset_file('domain', 'dataset', '2022-01-01T00:00:00-file.csv')
        self.s3_adapter.find_raw_file.assert_called_once_with('domain', 'dataset', '2022-01-01T00:00:00-file.csv')
        self.glue_adapter.check_crawler_is_ready.assert_called_once_with('domain', 'dataset')
    ...
    def test_delete_file_when_crawler_is_not_ready_before_deletion(self):
        self.glue_adapter.check_crawler_is_ready.side_effect = CrawlerIsNotReadyError('Not ready, try later')
        ...
        self.s3_adapter.find_raw_file.assert_called_once_with('domain', 'dataset', '2022-01-01T00:00:00-file.csv')
        self.glue_adapter.check_crawler_is_ready.assert_called_once_with('domain', 'dataset')
        assert not self.s3_adapter.delete_dataset_files.called, \
    ...
    def test_delete_file_when_crawler_is_not_ready_after_deletion(self):
        self.glue_adapter.start_crawler.side_effect = CrawlerStartFailsError('Not ready, try later')
        ...
        self.s3_adapter.find_raw_file.assert_called_once_with('domain', 'dataset', '2022-01-01T00:00:00-file.csv')
        self.glue_adapter.check_crawler_is_ready.assert_called_once_with('domain', 'dataset')
        self.s3_adapter.delete_dataset_files.assert_called_once_with('domain', 'dataset', '2022-01-01T00:00:00-file.csv')
        self.glue_adapter.start_crawler.assert_called_once_with('domain', 'dataset')
