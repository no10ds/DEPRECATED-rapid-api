...
class TestClientCreation:
    ...
    def test_create_client(self):
        expected_response = ClientResponse(
            ...
            scopes=[f"https://{DOMAIN_NAME}/WRITE_PUBLIC", f"https://{DOMAIN_NAME}/READ_PRIVATE"])
    ...
    cognito_response = {
        'UserPoolClient': {
            ...
            'AllowedOAuthScopes': [f"https://{DOMAIN_NAME}/WRITE_PUBLIC", f"https://{DOMAIN_NAME}/READ_PRIVATE"],
