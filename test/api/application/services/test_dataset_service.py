...
class TestWriteDatasets:
    ...
    def test_get_authorised_datasets(
        ...
        assert len(result) == 2
        assert "raw/test_domain_1/test_dataset_1/1" in result
        assert "raw/test_domain_2/test_dataset_2/2" in result
    ...
    def test_get_authorised_datasets_with_write_all_permission(
        ...
        assert len(result) == 3
        assert "raw/test_domain_1/test_public_dataset/1" in result
        assert "raw/test_domain_2/test_private_dataset/2" in result
        assert "raw/test_domain_3/test_protected_dataset/3" in result
    ...
    def test_get_authorised_datasets_for_write_public(
        ...
        assert len(result) == 1
        assert "raw/test_domain_1/test_dataset_1/3" in result
    ...
    def test_get_authorised_datasets_for_write_protected_domain(
        ...
        assert len(result) == 2
        assert "raw/some_domain/test_dataset_1/1" in result
        assert "raw/test2domain/test_dataset_2/1" in result
        assert mock_get_datasets_metadata.call_count == 2
        mock_get_permissions_for_subject.assert_called_once_with(subject_id)
...
class TestReadDatasets:
    ...
    def test_get_authorised_datasets_with_read_all_permission(
        ...
        assert len(result) == 3
        assert "raw/test_domain_1/test_public_dataset/2" in result
        assert "raw/test_domain_2/test_private_dataset/2" in result
        assert "raw/test_domain_3/test_protected_dataset/2" in result
        assert mock_get_datasets_metadata.call_count == 3
        mock_get_permissions_for_subject.assert_called_once_with(subject_id)
    ...
    def test_get_authorised_datasets_for_read_public(
        ...
        assert len(result) == 1
        assert "raw/test_domain_1/test_dataset_1/100" in result
        assert mock_get_datasets_metadata.call_count == 1
        mock_get_permissions_for_subject.assert_called_once_with(subject_id)
    ...
    def test_get_authorised_datasets_for_read_protected_domain(
        ...
        assert len(result) == 2
        assert "raw/some_domain/test_dataset_1/2" in result
        assert "raw/test2domain/test_dataset_2/1" in result
        assert mock_get_datasets_metadata.call_count == 2
        mock_get_permissions_for_subject.assert_called_once_with(subject_id)
