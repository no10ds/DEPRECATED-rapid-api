...
class TestCognitoAdapterClientMethods:
    ...
    def test_create_client_app(self):
        ...
        expected_response = {
            'UserPoolClient': {
                ...
                'RefreshTokenValidity': 30, 'TokenValidityUnits': {},
                'ExplicitAuthFlows': ['ALLOW_CUSTOM_AUTH', 'ALLOW_USER_SRP_AUTH',
        ...
        self.cognito_boto_client.create_user_pool_client.return_value = expected_response
    ...
    def test_raises_error_when_scope_does_not_exist_in_aws(self):
        ...
        with pytest.raises(UserError, match="One or more of the provided scopes do not exist"):
    ...
    def test_raises_error_when_the_client_fails_to_create_in_aws(self):
        ...
        with pytest.raises(AWSServiceError, match="The client 'my_client' could not be created"):
            self.cognito_adapter.create_client_app(client_request)
    ...
    def test_create_user_group_with_domain_and_dataset(self):
        ...
        self.cognito_boto_client.create_group.assert_called_once_with(
            GroupName='WRITE/my_domain/my_dataset',
            UserPoolId=COGNITO_USER_POOL_ID
        )
    ...
    def test_raises_error_when_create_user_group_fails(self):
        ...
        with pytest.raises(UserGroupCreationError,
    ...
    def test_raises_error_when_delete_user_group_fails(self):
        ...
        with pytest.raises(UserGroupDeletionError,
